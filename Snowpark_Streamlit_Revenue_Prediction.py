...
# Adjusted function to load data, now requires a session argument
...
# Streamlit config
st.set_page_config(page_title="SkiGear Co Ad Spend Optimizer", page_icon=APP_ICON_URL, layout="centered")
st.title("SkiGear Co Ad Spend Optimizer")

# Create Snowflake session and load data
session = create_session()
historical_data, df_last_six_months_allocations, df_last_six_months_roi, df_last_months_allocations = load_data(session)
